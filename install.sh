...
if command -v soloist >/dev/null 2>&1; then
    ...
    warn "soloist not found. This bot expects 'soloist' to run on this same dedicated server (see docs/DEPLOYMENT.md) — install it from spotify/soloist before starting the bot."
fi
...
echo
echo "  Still to do on this server before starting the bot:"
